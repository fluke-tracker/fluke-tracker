...
class BinaryHead(nn.Module):
    ...
    def __init__(self, num_class=2568*2, emb_size=2048, s=16.0):
...
class MarginHead(nn.Module):
    ...
    def __init__(self, num_class=2568*2, emb_size=2048, s=64., m=0.5):
...
class Net(nn.Module):
    ...
    def __init__(self, num_class=2568*2, s1=64, m1=0.5, s2=64, emb_size=2048):
