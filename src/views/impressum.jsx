    ...
    <div class="section container" style={{"paddingTop": "150px", "paddingBottom": "5px"}}>
        ...
        <div class="col-12">
                ...
                <div class="section__block article-text col-12 col-md-10 offset-md-1 ">
					<div class="section__block article-text col-12 col-md-10 offset-md-1 ">
					<h1 style={{"paddingTop": "20px"}}><strong>Impressum</strong></h1>
<h2>This site is edited by: / Ce site web est édité par :</h2>
<p>Capgemini Service SAS<br />
Société par actions simplifiée au capital de 8, 000,000 euros – 652 025 792 RCS Paris<br />
Siège social : 11 rue de Tilsitt, 75017 Paris<br />
Tel: +33 (0)1 47 54 50 00<br />
Publication Director: / Directeur de la publication : M. Paul Hermelin</p>
<h2>ISP: / Hébergeur :</h2>
<p><a href="https://automattic.com/" target="_blank" rel="noopener noreferrer">Automattic Inc</a><br />
60 29th Street #343<br />
San Francisco, CA 94110<br />
Tel: (877) 273-3049.</p>

        <h5 style={{"paddingTop": "5px"}}><a href="mailto:gdsc3_core.iandd@capgemini.com">Contact us</a></h5>
        </div>
				</div>
