                ...
                <div className="row">
                  <div className="col-12">
                    <div className="article-text">
                      <div className={'text-center flex-row'} style={{display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundSize: '100vw auto', minHeight: '400px', backgroundImage: 'url("https://upload.wikimedia.org/wikipedia/commons/b/b8/Sperm_whale_pod.jpg")'}}>
                        <Button color={'white'} onClick={() => this.props.history.push('/upload')}><Icon name="upload"/>Upload Whales</Button>
                        <Button color={'white'} onClick={() => this.props.history.push('/browse-pictures')}><Icon name="search"/>Browse Whales</Button>
                      </div>
                      ...
                      <video id="vid" src={require("../assets/mp4/whatcanyoudo.mp4")} height="100%" width="100%" autoPlay muted loop>
